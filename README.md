...
SurveyMatrix is a free and open-sourced Bootstrap themed Angular 9 starter project.
...
SurveyMatrix comes with a base implementation of navigation and layouts.
...
```bash
git clone git@github.com:startbootstrap/SurveyMatrix.git
cd SurveyMatrix
npm install
npm start
```
...
SurveyMatrix come with a production ready Dockerfile and build scripts.
